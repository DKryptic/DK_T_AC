...
namespace DK_T_AC
{
    class WAPI
    {
        ...
        [DllImport("kernel32.dll")]
        public static extern bool Module32Next(int hSnapshot, ref MODULEENTRY32 lpme);

        [DllImport("kernel32.dll")]
        public static extern bool Module32First(int hSnapshot, ref MODULEENTRY32 lpme);

        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern int CreateToolhelp32Snapshot(SnapshotFlags dwFlags, uint th32ProcessID);
        ...
        public static extern int LoadLibrary([MarshalAs(UnmanagedType.LPStr)] string lpFileName);
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern int VirtualAllocEx(int hProcess, int lpAddress, int dwSize,
            uint flAllocationType, uint flProtect);

        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern int CreateRemoteThread(int hProcess, int lpThreadAttribute, int dwStackSize,
            int lpStartAddress,
            int lpParameter, uint dwCreationFlags, int lpThreadId);

        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern uint WaitForSingleObject(int hHandle, uint dwMilliseconds);

        [DllImport("kernel32.dll")]
        public static extern bool GetExitCodeThread(int hThread, out int lpExitCode);

        [DllImport("kernel32.dll", SetLastError = true, ExactSpelling = true)]
        public static extern bool VirtualFreeEx(int hProcess, int lpAddress,
            int dwSize, FreeType dwFreeType);

        [DllImport("kernel32.dll", SetLastError = true, CallingConvention = CallingConvention.Winapi)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool IsWow64Process([In] int hProcess, [Out] out bool lpSystemInfo);
        ...
        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SetWindowPos(int hWnd, int hWndInsertAfter, int X, int Y, int cx, int cy,
            uint uFlags);
        ...
        [DllImport("user32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool ClientToScreen(int hWnd, out POINT lpPoint);

        [DllImport("gdi32.dll")]
        public static extern bool GetWindowOrgEx(int hdc, out POINT lpPoint);

        [DllImport("user32.dll")]
        public static extern bool SetLayeredWindowAttributes(int hwnd, uint crKey, byte bAlpha, uint dwFlags);

        [DllImport("dwmapi.dll", PreserveSig = true)]
        public static extern int DwmExtendFrameIntoClientArea(int hwnd, ref MARGINS margins);
        ...
        [DllImport("user32.dll")]
        public static extern bool ShowWindow(int hWnd, WindowShowStyle nCmdShow);
